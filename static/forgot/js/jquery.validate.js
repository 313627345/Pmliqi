...
//		console.debug("regX: %o, value: %o, test: %o", regX, value, regX.test(value));
	...
	}, $.validator.format("Please enter a value between {0} and {1}，rounding to {2} decimal places."));
	...
	$.extend($.validator.messages, {
		...
		rangelength : $.validator.format("Please enter a value between {0} and {1} characters long."),
		range : $.validator.format("Please enter a value between {0} and {1}."),
		max : $.validator.format("Please enter a value greater than or equal to {0}."),
		min : $.validator.format("Please enter a multiple of {0}."),
		ipv4 : 'Please enter the correct IP address',
		chId : 'Please enter the correct ID.',
		noSpace : 'Please do not enter a space here',
		alphanumeric : 'Please enter letters, numbers, combinations of underscores.',
		decimal : 'Please enter a value between {0} and {1}，rounding to {2} decimal places.'
	});
}));
